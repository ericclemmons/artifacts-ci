/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.local-actions.jsonc` (hash: 4469ad26a3b0b301ac54c1d1b4af3645)
// Runtime types generated with workerd@1.20260507.1 2026-04-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "RunLog" | "ProjectAgent" | "SchedulerAgent";
	}
	interface Env {
		RepoTokens: KVNamespace;
		RepoRemotes: KVNamespace;
		CacheBackups: KVNamespace;
		BackupBucket: R2Bucket;
		BuildIngressQueue: Queue;
		Artifacts: Artifacts;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
		RunLog: DurableObjectNamespace<import("./src/index").RunLog>;
		ProjectAgent: DurableObjectNamespace<import("./src/index").ProjectAgent>;
		SchedulerAgent: DurableObjectNamespace<import("./src/index").SchedulerAgent>;
		DeployWorkflow: Workflow<Parameters<import("./src/index").ArtifactsWorkflow['run']>[0]['payload']>;
		PagesWorkflow: Workflow<Parameters<import("./src/index").PagesWorkflow['run']>[0]['payload']>;
		WorkersBuildsWorkflow: Workflow<Parameters<import("./src/index").WorkersBuildsWorkflow['run']>[0]['payload']>;
	}
}
