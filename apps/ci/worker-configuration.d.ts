/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9d77635d709f577c48af5239a36f9c50)
// Runtime types generated with workerd@1.20260426.1 2026-04-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "RunLog";
	}
	interface Env {
		REPO_TOKENS: KVNamespace;
		REPO_REMOTES: KVNamespace;
		CACHE_BACKUPS: KVNamespace;
		...
		DEPLOY_WORKFLOW: Workflow<Parameters<import("./src/index").DeployWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CI_RUNNER" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
